...
namespace Legacy
{
    ...
    /*
    public class Legacy_Slot : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
    {
        ...
        public void LoadItem(BaseItem item, int itemCount)
        {
            if (item != null)
            {
                Item = item;
        ...
        public void AddItemToSlot(BaseItem item, int itemCount = 1)
        {
            if (item == null)
            {
                ClearSlot();
        ...
        public void RemoveItemFromSlot(BaseItem item, int itemCount = 1)
        {
        ...
        public void SetSlotStrategy(Legacy_Slot targetSlot)
        {
            BaseItem dragItem = DragSlot.Instance.Item;
            ...
            BaseItem temporaryItem = targetSlot.Item;
