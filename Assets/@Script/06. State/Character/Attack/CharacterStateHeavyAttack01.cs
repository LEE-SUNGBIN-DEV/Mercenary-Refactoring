...
public class CharacterStateHeavyAttack01 : ICharacterState
{
    ...
    {
        stateWeight = (int)CHARACTER_STATE_WEIGHT.Heavy_Attack_01;
        animationNameHash = Constants.ANIMATION_NAME_HEAVY_ATTACK_01;
        mouseLeftDown = false;
    }
