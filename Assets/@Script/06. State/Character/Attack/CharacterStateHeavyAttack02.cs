...
public class CharacterStateHeavyAttack02 : ICharacterState
{
    ...
    {
        stateWeight = (int)CHARACTER_STATE_WEIGHT.Heavy_Attack_02;
        animationNameHash = Constants.ANIMATION_NAME_HEAVY_ATTACK_02;
        mouseLeftDown = false;
    }
