...
public class SwordShieldHeavyAttack03 : IActionState
{
    ...
    public SwordShieldHeavyAttack03(PlayerCharacter character)
    {
        ...
        animationNameHash = Constants.ANIMATION_NAME_HASH_SWORD_SHIELD_HEAVY_ATTACK_03;
        mouseLeftDown = false;
    }
    ...
    public void Update()
    {
        ...
        // -> Light Attack 1
        if (mouseLeftDown && character.State.SetStateByAnimationTimeUpTo(animationNameHash, ACTION_STATE.PLAYER_SWORD_SHIELD_ATTACK_LIGHT_03, 0.8f))
        {
            return;
        }
