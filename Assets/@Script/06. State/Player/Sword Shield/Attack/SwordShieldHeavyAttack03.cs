...
public class SwordShieldHeavyAttack03 : IActionState
{
    ...
    public SwordShieldHeavyAttack03(PlayerCharacter character)
    {
        ...
        animationClipInfo = character.AnimationClipTable["Sword_Shield_Heavy_Attack_03"];
    ...
    public void Enter()
    {
        character.StatusData.ConsumeStamina(Constants.SWORD_SHIELD_STAMINA_CONSUMPTION_HEAVY_ATTACK_03);
    ...
    private IEnumerator CoEnableCombat()
    {
        ...
        swordShield.EnableSword(COMBAT_ACTION_TYPE.SWORD_SHIELD_ATTACK_HEAVY_03);
