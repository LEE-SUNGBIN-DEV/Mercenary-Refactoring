...
public class SwordShieldWalk : IActionState
{
    ...
    public SwordShieldWalk(PlayerCharacter character)
    {
        ...
        animationClipInformation = character.AnimationClipDictionary["Sword_Shield_Walk"];
    }
        ...
        switch (character.MoveController.GetGroundState())
        {
            case ACTOR_GROUND_STATE.GROUND:
                ...
                if (moveDirection.sqrMagnitude > 0f)
                {
                    ...
                    {
                        character.MoveController.SetMoveInformation(moveDirection, character.Status.MoveSpeed);
                    }
                }
                // Idle
                else
