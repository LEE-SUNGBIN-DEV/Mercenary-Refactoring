...
{
    public override void SetMovementAndRotation(Vector3 moveDirection, float moveSpeed, float rotationSpeed = Constants.PLAYER_DEFAULT_ROTATION_SPEED)
    {
    ...
    public override void SetGroundStateAndValue(ACTOR_GROUND_STATE groundState)
    {
        switch (groundState)
        {
            ...
            case ACTOR_GROUND_STATE.SLIDING:
                ...
                fallingSpeed += Constants.GRAVITY_DEFAULT * Time.deltaTime;
                state.SetState(ACTION_STATE.PLAYER_SLIDE, STATE_SWITCH_BY.WEIGHT);
            ...
            case ACTOR_GROUND_STATE.FALLING:
                ...
                fallingSpeed += Constants.GRAVITY_DEFAULT * Time.deltaTime;
                state.SetState(ACTION_STATE.PLAYER_FALL, STATE_SWITCH_BY.WEIGHT);
