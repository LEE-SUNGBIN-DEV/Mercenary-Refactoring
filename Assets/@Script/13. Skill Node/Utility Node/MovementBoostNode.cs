...
public class MovementBoostNode : BaseSkillNode
{
    ...
    {
        characterData.StatusData.SkillMoveSpeed -= currentSkillLevel * increasePerLevel;
    }
    ...
    {
        skillDescription =
            $"이동속도를 <color=#C8A050>{currentSkillLevel * increasePerLevel}%</color> 증가 시킵니다. (레벨당 <color=#C8A050>{increasePerLevel}%</color> 증가)";
