...
public class PlayerHalberd : PlayerWeapon
{
    ...
    public override void AddCommonStateInforamtion()
    {
        ...
        basicStateInformation.idleState = ACTION_STATE.PLAYER_HALBERD_IDLE;
        basicStateInformation.walkState = ACTION_STATE.PLAYER_HALBERD_WALK;
        basicStateInformation.runState = ACTION_STATE.PLAYER_HALBERD_RUN;
    }
