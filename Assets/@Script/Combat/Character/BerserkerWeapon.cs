...
public class BerserkerWeapon : PlayerWeapon
{
    ...
    public override void SetWeapon(BaseCharacter character)
    {
        ...
        {
            // Combo Attack
            {BERSERKER_ATTACK_TYPE.ComboAttack1, new CombatInformation(HIT_TYPE.Light, 1f, ABNORMAL_TYPE.None, 0f, new Vector3(-0.507f, 1.039f, 3.009f), new Vector3(-11.366f, 173.507f, -147.071f)) },
            ...
            {BERSERKER_ATTACK_TYPE.SmashAttack3, new CombatInformation(HIT_TYPE.Heavy, 2.16f, ABNORMAL_TYPE.None, 0f, new Vector3(-0.343f, 1.589f, 1.832f), new Vector3(190.228f, -5.038f,-315.176f)) },
    ...
    public void OnEnableAttack(BERSERKER_ATTACK_TYPE attackType)
    {
        ...
        switch (attackType)
        {
            ...
            case BERSERKER_ATTACK_TYPE.SmashAttack3:
