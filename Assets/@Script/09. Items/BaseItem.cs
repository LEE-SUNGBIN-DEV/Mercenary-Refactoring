...
public abstract class BaseItem
{
    ...
    public bool CheckItemTable(ItemData itemData)
    {
        if (Managers.DataManager.ItemTable.ContainsKey(itemData.itemID))
            return true;
        else
            return false;
    }
    ...
    public CharacterStatusData StatusData { get { return Managers.DataManager?.CurrentCharacterData?.StatusData; } }
    #endregion
}
